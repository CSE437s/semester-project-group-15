//
//  FullTestSharingExperienceTestView.swift
//  spaiDemo2
//
...
struct FullTestSharingExperienceTestView: View {
    @EnvironmentObject var viewModel: TestViewModel
    @State private var questionText: String?
    @State private var isNextQuestionButtonEnabled = false
    @State private var showListeningComprehensionTest = false
    ...
    var body: some View {
        VStack {
            ...
            Button("Next Question") {
                showListeningComprehensionTest = true
            }
        ...
        .fullScreenCover(isPresented: $showListeningComprehensionTest) {
